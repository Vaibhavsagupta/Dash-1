    ...
    for attempt in range(1, max_retries + 1):
        try:
            for stmt in [
                ...
                "ALTER TABLE test_assignments ADD COLUMN IF NOT EXISTS assigned_at TIMESTAMP;",
                "ALTER TABLE test_assignments ADD COLUMN IF NOT EXISTS attempt_limit INT DEFAULT 1;",
                "ALTER TABLE test_assignments ALTER COLUMN assigned_by DROP NOT NULL;",
                "ALTER TABLE questions ADD COLUMN IF NOT EXISTS options TEXT;",
                "ALTER TABLE questions ADD COLUMN IF NOT EXISTS test_id VARCHAR;",
                ...
                "ALTER TABLE questions ADD COLUMN IF NOT EXISTS topic VARCHAR;",
                "ALTER TABLE questions ADD COLUMN IF NOT EXISTS subtopic VARCHAR;",
